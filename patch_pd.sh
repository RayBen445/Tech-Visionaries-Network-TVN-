...
sed -i 's/Create your profile/Explore All Builders/g' src/components/PeopleDiscovery.tsx
sed -i 's/<\/button>/<\/a>/g' src/components/PeopleDiscovery.tsx
